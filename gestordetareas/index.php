                    ...
                    <div class="row">
                        ...
                        <div class="py-1 col-4">
                            ...
                            <select name="lstUsuario" id="lstUsuario" class="form-control" required>
                                <option value="" disabled selected>Seleccionar</option>
                                <option value="Doris" <?php echo isset($aTareas[$id]) && $aTareas[$id]["usuario"] == "Doris" ? "selected" : "";?>>Doris</option>
                                <option value="Laura" <?php echo isset($aTareas[$id]) && $aTareas[$id]["usuario"] == "Laura" ? "selected" : "";?>>Laura</option>
                                <option value="Sandra" <?php echo isset($aTareas[$id]) && $aTareas[$id]["usuario"] == "Sandra" ? "selected" : "";?>>Sandra</option>
                            </select>
                        </div>
                        <div class="py-1 col-4">
